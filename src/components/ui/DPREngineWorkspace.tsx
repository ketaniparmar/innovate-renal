...
import { 
  ...
  AlertTriangle, BarChart3, Binary
} from "lucide-react";
...
export default function DPREngineWorkspace() {
  ...
  // --- MATHEMATICAL UNDERWRITING ENGINE ---
  ...
  return (
    <main className="min-h-screen bg-[#0A0F1C] text-slate-200 selection:bg-[#C6A85A] selection:text-black flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em]">
              ...
              <span className="text-white">v8.0 Project Underwriting</span>
            </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        {/* PARAMETER SIDEBAR (8x8 GRID BASE) */}
        <aside className="w-full lg:w-[440px] border-r border-white/5 bg-[#0A0F1C] flex flex-col h-full overflow-y-auto p-8 space-y-12 custom-scrollbar">
      ...
      <LeadCaptureModal 
        ...
        source="Sovereign v8.0 Underwriting"
...
// --- CALCULATION RE-ENGINES (V8 STANDARDS) ---
